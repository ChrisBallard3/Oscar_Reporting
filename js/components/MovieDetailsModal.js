...
setTimeout(() => {
    ...
    if (oscarButton) {
        oscarButton.removeEventListener("click", openOscarModal); // Prevent duplicate listeners
...
}, 200); // Small delay to ensure button is in the DOM
...
// Ensure tab switching works when clicking tabs
